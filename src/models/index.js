...
function getSingle(req) {
  ...
  return new Promise(async (resolve, reject) => {
    /*eslint-enable */
    if (
      (req.query.line && req.query.line.length > 0) ||
      ...
      reject(
        `Please use the endpoint with a get param of 'line'. example https://mtastate.herokuapp.com/?line=123`
      );
    }
  });
}
